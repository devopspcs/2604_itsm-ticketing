              ...
              <div className="col-span-2">
                <div className="flex items-center gap-1.5">
                  <span className={`w-1.5 h-6 rounded-full ${
                    ...
                    t.priority === 'medium' ? 'bg-amber-500' : 'bg-blue-400'
                  }`} />
                  <span className={`text-xs font-bold uppercase ${
                    t.priority === 'critical' || t.priority === 'high' ? 'text-error' :
                    t.priority === 'medium' ? 'text-amber-600' : 'text-blue-500'
                  }`}>{t.priority}</span>
                </div>
              </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white/80 p-6 rounded-2xl shadow-sm flex flex-col justify-between h-48 border border-outline-variant/10">
          <div className="flex justify-between items-start">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest bg-blue-100 text-blue-700 px-2 py-1 rounded">Volume</span>
          </div>
          <div>
